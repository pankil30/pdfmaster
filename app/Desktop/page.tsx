...
//   <Image src={task.image} alt={task.title} fill className="object-contain" />
// </div>
...
//  <Link href="/pricing/checkout" className="mt-8 w-full block text-center rounded-xl bg-emerald-500 py-4 text-lg font-semibold text-white hover:bg-emerald-600">
//   Select
// </Link>
...
const pdfTasks = [
  {
    ...
    title: "Merge files into one PDF",
    description:
      "Combine multiple PDFs, reorder pages visually, or interleave odd and even pages from separate scans.",
  },
  {
    id: 2,
    image: "/ab.jpg",
    title: "Split PDF files",
    description:
      "Split by page range, file size, bookmarks, or specific text. Handy for dividing two-page-layout scans back into single pages.",
  },
  {
    id: 3,
    image: "/ad.jpg",
    title: "Convert PDF files to Office and image formats",
    description:
      "Convert to Word, Excel, or image formats — and images back into PDF.",
  },
  {
    id: 4,
    image: "/aa.jpg",
    title: "Compress PDF",
    description: "Shrink file size by optimizing embedded images and resources.",
  },
  {
    id: 5,
    image: "/ae.jpg",
    title: "Edit PDF files",
    description:
      "Add, edit, or move text. Change fonts, sizes, and styles. Reorder or delete pages, add a signature, highlight text, or drop in shapes.",
  },
  {
    id: 6,
    image: "/af.jpg",
    title: "Apply PDF passwords and restrictions",
    description:
      "Lock down copying or editing, or add a password so only people you approve can open the file.",
  },
];

// NOTE: Verify every claim in this FAQ set is accurate to your actual
// billing setup before publishing — see flagged concerns above.
const faqs = [
  {
    question: "How can I cancel my subscription?",
    answer: [
      "Visit your account page and click 'Stop auto-renewal', or reach out to support by email.",
      "The Week Pass is a one-time purchase and doesn't auto-renew — it simply expires after 7 days.",
    ],
  },
  {
    question: "What's the difference between PDFMaster Desktop and PDFMaster Web?",
    answer: [
      "Web runs in your browser and processes files on our servers, deleting them shortly after.",
      "Desktop installs on your computer and processes files locally — nothing gets uploaded.",
    ],
  },
  {
    question: "Will my subscription auto-renew?",
    answer: [
      "The Week Pass is one-time and doesn't renew.",
      "Annual subscriptions renew automatically at the end of each billing cycle unless you cancel.",
    ],
  },
  {
    question: "Does PDFMaster Desktop process files locally?",
    answer: [
      "Yes — files stay on your computer and are never uploaded to our servers.",
    ],
  },
  {
    question: "Can I use PDFMaster Desktop on more than one computer?",
    answer: [
      "One license covers both your laptop and desktop, as long as you're the only person using it.",
    ],
  },
  {
    question: "Do you offer a lifetime license?",
    answer: [
      "Right now it's weekly and annual plans, plus enterprise licensing for businesses.",
    ],
  },
];

const steps = [
  "Open a file in PDFMaster Desktop for Linux, or use the online editor instead.",
  "Select the Text tool from the top menu.",
  "Click existing text to edit it, or click anywhere blank to add new text.",
  "Drop in images — drag to move, resize, or rotate them.",
  "Fill out form fields and add a signature. Draw it, type it, or upload one.",
  "Highlight text, leave comments, or mark changes with strikethrough.",
  "Add links to web pages or other spots in the document, or edit existing ones.",
  "Use find-and-replace, whiteout a section, or insert shapes.",
  "Click Apply Changes to save the edited file.",
];
...
export default function DesktopPage() {
  return (
    <main className="overflow-hidden bg-white">
      ...
      <section className="relative">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-16 px-6 py-24 lg:flex-row">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-xl leading-9 text-gray-600">
              Edit, convert, compress, and sign PDFs offline — everything
              runs on your machine, nothing gets uploaded.
            </p>

            <a
              href="/pdfmaster.msi"
              download="pdfmaster.msi"
              className="mt-10 inline-flex items-center gap-3 rounded-2xl bg-blue-600 px-8 py-5 text-xl font-semibold text-white transition hover:bg-blue-700"
            >
              <Download size={28} />
              Free Download
          ...
          <div>
            <Image
              src="/ah.jpg"
              alt="PDFMaster Desktop application window"
              width={700}
              height={600}
              priority
            />
      ...
      {/*
        FLAGGED: This pricing section (Free/Premium tiers with specific
        limits) needs to be verified against what's actually enforced in
        the app, and reconciled with the "100% free" messaging on your
        About, FAQ, and WhyChooseUs pages before this goes live.
      */}
      <section className="relative overflow-hidden bg-gradient-to-b from-gray-50 to-white py-24">
        <div className="absolute top-0 left-0 w-full">
          <svg
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          ...
          <div className="mb-16 text-center">
            <h2 className="text-4xl font-bold text-gray-900">
              Generous free limits, upgrade if you need more
            </h2>
            <p className="mt-3 text-xl text-gray-500">
              Most people never hit the free plan's ceiling.
            </p>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div className="rounded-3xl border border-green-100 bg-green-50 p-10 shadow-lg">
              <h3 className="text-3xl font-bold text-green-600">PREMIUM</h3>
              <ul className="mt-8 space-y-5 text-lg">
                <li>🚀 Unlimited PDF tasks</li>
                <li>🚀 Unlimited file size</li>
          ...
          <div className="mt-20 text-center">
            ...
            <p className="mt-3 text-gray-600">
              Upload a file and try the free tools right now — no signup.
            </p>
            <Link
              href="/pdf-editor"
              className="mt-8 inline-flex rounded-xl bg-blue-600 px-10 py-4 text-lg font-semibold text-white transition hover:bg-blue-700"
      ...
      <section className="py-16 px-4 bg-white">
        <h2 className="text-center text-2xl font-semibold text-gray-800 mb-12">
          What you can do with PDFMaster
        </h2>
      ...
      {/*
        FLAGGED: "Citrix™ and Terminal Services™ compatible" is a specific
        technical compatibility claim. Only keep this if it's actually true
        and tested — otherwise remove it. Trademark symbols on products you
        don't own/haven't verified compatibility with can also be a legal
        issue, not just an accuracy one.
      */}
      <section className="bg-gray-100 py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-8">
                Built to deploy across a whole team
              </h2>

              <ul className="space-y-5">
                <li className="flex items-start gap-3 text-xl text-gray-700">
                  <Check className="w-6 h-6 text-blue-600 mt-1 flex-shrink-0" />
                  <span>Pre-activated deployments with a volume license key</span>
                </li>
                <li className="flex items-start gap-3 text-xl text-gray-700">
                  <Check className="w-6 h-6 text-blue-600 mt-1 flex-shrink-0" />
                  <span>[VERIFY] Citrix and Terminal Services compatibility</span>
                </li>
                <li className="flex items-start gap-3 text-xl text-gray-700">
                  <Check className="w-6 h-6 text-blue-600 mt-1 flex-shrink-0" />
                  <span>Volume discounts starting at 2 licenses</span>
                </li>
              </ul>
      ...
      {/*
        FLAGGED: Confirm the payment backend behind these "Select" buttons
        actually works before this goes live — a non-functional checkout
        button is worse than not having pricing on the page at all.
      */}
      <section className="bg-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-5 text-xl text-gray-500">
              Free to use with daily limits — upgrade for unlimited use.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-10 lg:grid-cols-2 max-w-4xl mx-auto">
            ...
            <div className="relative rounded-3xl border-2 border-emerald-500 bg-white p-10 shadow-lg transition hover:-translate-y-2 hover:shadow-xl">
              ...
              <div className="mt-8 text-center">
                ...
                <span className="text-6xl font-bold">7</span>
                <span className="text-3xl font-bold">.95</span>
                <p className="mt-2 text-gray-500">for 7 days access</p>
              </div>
              ...
              <Link
                ...
                className="mt-8 block w-full rounded-xl bg-emerald-500 py-4 text-center text-lg font-semibold text-white hover:bg-emerald-600"
              >
                Select
              </Link>
              ...
              <ul className="space-y-4">
                {["Latest features", "7 days access to Desktop", "7 days access to Web"].map(
                  (item) => (
            ...
            <div className="rounded-3xl bg-white p-10 shadow-lg transition hover:-translate-y-2 hover:shadow-xl">
              ...
              <div className="mt-8 text-center">
                <span className="text-2xl font-semibold">$</span>
                <span className="text-6xl font-bold">63</span>
                <p className="mt-2 text-gray-500">per year</p>
              </div>
              ...
              <ul className="space-y-4">
                {["Latest features", "1 year access to Desktop", "1 year access to Web"].map(
                  (item) => (
                    <li key={item} className="flex items-center gap-3 text-gray-700">
                      <Check className="text-emerald-500" size={20} />
                      {item}
          ...
          <div className="grid lg:grid-cols-2 gap-x-20 gap-y-14">
            {faqs.map((faq, index) => (
              <div key={index}>
                ...
                <div className="space-y-4">
                  {faq.answer.map((text, i) => (
                    <p key={i} className="text-lg leading-8 text-gray-600">
                      {text}
                    </p>
                  ))}
                </div>
      ...
      <section className="bg-slate-100 py-24">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-gray-900">
            Editing PDFs on Ubuntu, Linux, or a Chromebook
          </h2>

          <p className="mt-3 text-xl text-gray-500">
            The desktop app runs on Linux directly — here's the process.
          </p>
          ...
          <ol className="mt-12 space-y-7">
            {steps.map((step, index) => (
              <li key={index} className="flex items-start gap-6">
                ...
                <p className="text-lg leading-6 text-gray-700">{step}</p>
              </li>
            ))}
          </ol>
        </div>
